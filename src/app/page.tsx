    ...
    <div className="min-h-screen bg-white font-sans selection:bg-blue-100 text-slate-900 overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 md:pt-60 md:pb-32 px-6 bg-gradient-to-b from-blue-50/40 to-white overflow-hidden text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h2 className="text-3xl md:text-7xl font-extrabold text-slate-900 mb-6 md:mb-10 leading-tight tracking-tighter break-keep">
            토·일 주말 진료, <br />
          ...
          <Link href={NAVER_BOOKING_URL} target="_blank" rel="noopener noreferrer" className="inline-block bg-slate-900 text-white px-8 py-4 md:px-12 md:py-6 rounded-2xl font-bold text-sm md:text-base hover:bg-blue-900 transition-all shadow-xl active:scale-95">
            네이버 실시간 예약하기
          </Link>
        </div>
      </section>

      {/* 3. 의료진 소개 (누락된 약력 전체 복구) */}
      <section id="intro" className="py-16 md:py-32 px-6 max-w-6xl mx-auto">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="w-full pt-4">
            ...
            {/* 🌟 학력 및 전문의 🌟 */}
            <div className="mb-10">
              <p className="text-blue-900 font-bold text-xs mb-5 tracking-widest uppercase border-l-4 border-blue-900 pl-3">학력 및 전문의</p>
              <ul className="space-y-4 text-slate-700 text-sm md:text-[17px] break-keep">
                ...
                <li className="flex items-start gap-3 font-semibold"><span className="w-1.5 h-1.5 bg-blue-900 rounded-full mt-2 shrink-0"></span> 서울대학교 치의학대학원 석사</li>
                <li className="flex items-start gap-3 font-extrabold text-blue-900 italic"><span className="w-1.5 h-1.5 bg-blue-900 rounded-full mt-2 shrink-0"></span> 보건복지부 인증 통합치의학 전문의</li>
                <li className="flex items-start gap-3 font-semibold"><span className="w-1.5 h-1.5 bg-blue-900 rounded-full mt-2 shrink-0"></span> 가톨릭대학교 임상치과대학원 치과교정학 전공</li>
              </ul>
            </div>
            ...
            <div className="mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <ul className="space-y-3 text-slate-700 text-xs md:text-sm font-bold">
            ...
            <div>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-slate-500 text-xs md:text-[13px]">
      ...
      <section id="blog" className="py-16 md:py-32 px-6 bg-white border-t">
        <div className="max-w-6xl mx-auto text-center md:text-left">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-6">
            <div>
              <span className="text-blue-900 font-black text-[10px] uppercase tracking-[0.2em] mb-2 block italic">Medical Column</span>
              <h3 className="text-2xl md:text-4xl font-bold text-slate-900 mb-3 tracking-tight">대표원장이 직접 쓰는 진료 이야기</h3>
              <p className="text-sm md:text-lg text-slate-500 font-medium break-keep">환자분들께 꼭 알려드리고 싶은 치아 건강 정보</p>
            </div>
            <Link href={BLOG_MAIN_URL} target="_blank" className="bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold text-xs md:text-sm active:scale-95 shadow-lg">블로그 전체보기 →</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, i) => (
              <Link key={i} href={post.link} target="_blank" className="group bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm active:bg-slate-50">
                ...
                <div className="p-7">
                  <span className="inline-block px-3 py-1 bg-blue-50 text-blue-900 text-[9px] font-black rounded-full mb-4 uppercase">{post.category}</span>
                  ...
                  <div className="flex justify-between items-center text-slate-400 text-[9px] font-bold uppercase border-t pt-4">
                    <span>{post.date}</span>
        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-10">
          <div className="bg-white rounded-[2rem] p-6 md:p-12 shadow-2xl border border-slate-100">
            <div className="flex justify-between items-center border-b border-blue-50 pb-4 mb-8">
              ...
              <span className="bg-red-50 text-red-600 px-3 py-1 rounded-full text-[9px] md:text-[11px] font-black">목요일 휴진</span>
            </div>
            <div className="space-y-6">
              <div className="flex justify-between items-center px-2">
                <span className="font-bold text-sm md:text-lg text-slate-400 italic">월 화 수 금</span>
              ...
              <div className="bg-blue-900 p-6 md:p-8 rounded-3xl text-white shadow-xl relative overflow-hidden">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-[8px] md:text-[10px] bg-white text-blue-900 px-2 py-0.5 rounded font-black">토·일 진료</span>
                </div>
                <div className="flex justify-between items-end">
                  <p className="text-blue-100 text-[10px] md:text-sm font-bold">일요일도 오후 4시까지 진료</p>
                  <span className="font-black text-2xl md:text-4xl tracking-tighter">10:00 - 16:00</span>
                </div>
              </div>
            </div>
            <div className="mt-10">
              <a href="tel:053-216-3636" className="w-full bg-slate-900 text-white p-6 rounded-2xl flex justify-between items-center active:bg-blue-900 shadow-xl">
                <div>
                  <p className="text-[9px] font-black text-blue-300 uppercase mb-1 tracking-widest">Reservation</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 mx-1">
              <p className="text-slate-800 font-extrabold text-lg md:text-xl mb-1 break-keep">대구광역시 동구 동부로 30길 12 3층</p>
              <p className="text-slate-500 font-bold text-sm italic">스타벅스 건물 3층 / 건물 내 전용 주차장 완비</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 px-6 bg-white text-center border-t">
        <p className="text-slate-900 font-black text-xs mb-3 italic tracking-widest uppercase">Seoul Hans Dental Clinic</p>
        <p className="text-slate-400 text-[9px] font-bold leading-relaxed break-keep">
