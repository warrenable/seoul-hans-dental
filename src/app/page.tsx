    ...
    <div className="bg-white min-h-screen font-sans text-gray-900 scroll-smooth">
      ...
      <header className="sticky top-0 bg-white/90 backdrop-blur-md border-b border-gray-100 z-50 transition-all">
        <div className="max-w-7xl mx-auto px-4 py-5 flex justify-between items-center">
          ...
          <nav className="hidden lg:flex space-x-8 text-[15px] font-semibold text-gray-700">
            <a href="#staff" className="hover:text-black transition-colors">의료진 소개</a>
            <a href="#treatments" className="hover:text-black transition-colors">진료과목</a>
            <a href="#blanc-film" className="hover:text-black transition-colors">Blanc Film</a>
            <a href="#implant" className="hover:text-black transition-colors">임플란트</a>
            <a href="#cases" className="hover:text-black transition-colors">증례별 전후사진</a>
            <a href="#gallery" className="hover:text-black transition-colors">둘러보기</a>
            <a href="#location" className="hover:text-black transition-colors">오시는 길</a>
          </nav>
        </div>
      </header>

      {/* 2. Hero Section (메인 비주얼 - 풀스크린 배경 이미지 적용) */}
      <section className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 mt-20">
          <p className="text-sm font-bold tracking-[0.2em] text-gray-500 mb-6">SEOUL BLANC DENTAL</p>
      ...
      {/* 4. Medical Staff (의료진 소개 - 이미지 공간 확보) */}
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
              <div className="h-96 bg-gray-200 relative">
                <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?auto=format&fit=crop&w=800&q=80" alt="백진아 원장" className="w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-500" />
              </div>
              <div className="p-10">
                <h3 className="text-2xl font-bold mb-6 border-b border-gray-100 pb-4">대표원장 백진아</h3>
                <ul className="text-gray-600 space-y-3 text-[15px] leading-relaxed">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
              <div className="h-96 bg-gray-200 relative">
                <img src="https://images.unsplash.com/photo-1594824436998-d8ea3fa8448a?auto=format&fit=crop&w=800&q=80" alt="오윤정 원장" className="w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-500" />
              </div>
              <div className="p-10">
                <h3 className="text-2xl font-bold mb-6 border-b border-gray-100 pb-4">라미네이트 수석원장 오윤정</h3>
                <ul className="text-gray-600 space-y-3 text-[15px] leading-relaxed">
      ...
      {/* 5. Blanc Film (무삭제 라미네이트 - 다크 테마 및 넓은 이미지) */}
      ...
      <section id="implant" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* 표면 라인업 비교 테이블을 시각화한 이미지 플레이스홀더 */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between border-b border-gray-300 pb-10 mb-8 gap-8">
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-gray-800 mb-6">서울블랑치과의원</h2>
              <p>주소 : 서울 구로구 디지털로 243 지하이시티 2층 202호</p>
              <p>상호명 : 서울블랑치과의원 | 대표 : 백진아 | 사업자등록번호 : 433-16-02801</p>
              <p>대표전화 : <span className="font-bold text-gray-800">02-2224-0055</span> | 팩스 : 02-2224-0056</p>
            </div>
            <div className="md:text-right space-y-2">
              <h3 className="font-bold text-gray-800 mb-6 text-lg">진료시간</h3>
              <p>월, 수 : PM 02:00 ~ PM 09:00 (휴게시간 PM 05:00-PM 05:30)</p>
              <p>화, 금 : AM 10:30 ~ PM 07:00 (휴게시간 PM 01:00-PM 02:00)</p>
              <p>토요일 : AM 10:00 ~ PM 02:30 (휴게시간 없음)</p>
              <p className="text-red-500 font-bold mt-2">※ 목요일, 일요일 및 공휴일 휴진</p>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p>© 2026 Seoul Blanc Dental Clinic. All Right Reserved.</p>
            <div className="flex space-x-6 font-medium text-gray-600">
              <a href="#" className="hover:text-black transition-colors">네이버 블로그</a>
              <a href="#" className="hover:text-black transition-colors">인스타그램</a>
              <a href="#" className="hover:text-black transition-colors">카카오 채널</a>
              <a href="#" className="hover:text-black transition-colors">비급여 항목</a>
            </div>
          </div>
        </div>
      </footer>
