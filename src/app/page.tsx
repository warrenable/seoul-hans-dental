...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-blue-100 text-slate-900">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-blue-50/50 p-5">
        <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
          ...
          <Link 
            ...
            className="bg-blue-600 text-white px-6 py-2.5 rounded-full text-xs font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all"
          >
            실시간 예약
          </Link>
        </div>
      ...
      {/* 2. 히어로 섹션 */}
      <section className="pt-48 pb-24 px-6 text-center bg-gradient-to-b from-blue-50/30 to-white font-sans">
      ...
      <section id="intro" className="py-32 px-6 max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div className="pt-4">
            ...
            <div className="mb-10">
              <p className="text-blue-600 font-bold text-sm mb-4 tracking-widest">학력 및 전문의</p>
            ...
            <div className="mb-10 p-6 bg-slate-50 rounded-2xl border border-slate-100">
              <p className="text-blue-600 font-bold text-xs mb-4 uppercase tracking-tighter">인증 및 연구 협력</p>
            ...
            <div>
              <p className="text-slate-400 font-bold text-xs mb-4 uppercase">학회 및 수료</p>
      ...
      <section id="location" className="py-32 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-white/95 backdrop-blur-md px-6 py-4 rounded-2xl shadow-xl flex justify-between items-center">
                  ...
                  <span className="bg-blue-600 text-white text-[10px] px-4 py-1.5 rounded-full font-bold">길찾기</span>
                </div>
              </div>
            </Link>
          ...
          <div className="bg-white rounded-3xl p-10 shadow-xl border border-slate-100 flex flex-col justify-between">
              ...
              <div className="space-y-6 text-slate-600">
                ...
                <div className="bg-blue-600 p-6 rounded-3xl text-white shadow-xl shadow-blue-100">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-extrabold text-xl tracking-tight text-shadow-sm">토 · 일 (주말 진료)</span>
                    <span className="text-xs bg-white text-blue-600 px-2 py-0.5 rounded font-bold uppercase">Open</span>
                  </div>
            ...
            <div className="mt-12 p-8 bg-slate-900 rounded-3xl text-white flex justify-between items-center">
              <div>
                <p className="text-blue-300 text-[10px] font-bold uppercase tracking-[0.2em] mb-1">RESERVATION</p>
                <p className="text-2xl font-black tracking-tight">053-216-3636</p>
              </div>
